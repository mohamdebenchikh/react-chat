...
const AuthLayout = ({ isAuth }) => {
  ...
  }, [isAuth, navigate]); // Include dependencies

  return (
    <div className="dark:bg-gray-900 min-h-screen w-full overflow-hidden">
      <div className="flex h-screen relative w-full justify-center items-center p-4">
        <Outlet />
      </div>
    </div>
  );
...
export default function App() {
  ...
  return (
    <Router>
      <Routes>
        <Route element={<AuthLayout isAuth={user !== null} />}>
